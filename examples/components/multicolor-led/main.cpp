/**
 * @file main.cpp
 * @brief MulticolorLed minimal executable example.
 *
 * @details
 * Shows RGB channel storage and global brightness scaling.
 *
