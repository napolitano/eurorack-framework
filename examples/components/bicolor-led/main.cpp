...
int main() {
    ...
    eurorack::controls::BiColorLed led({eurorack::controls::BiColorLedTopology::CommonCathode,
    ...
    return led.snapshot().effectiveColor == eurorack::controls::BiColorLedColor::ColorA ? 0 : 1;
}
