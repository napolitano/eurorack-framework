 ...
 *
 * @details
 * Models one maintained On contact, a center Off position, and one spring-return momentary On contact using two independent electrical inputs.
 *
...
struct OnOffMomentarySwitchSnapshot final {
    ...
    OnOffMomentaryPosition previousPosition{OnOffMomentaryPosition::Off}; ///< Position before last accepted change.
...
public:
     ...
     */
    void reset(bool maintainedRawHigh,
               bool momentaryRawHigh,
     ...
     * @param nowMs Current monotonic milliseconds.
     */
    void update(bool maintainedRawHigh,
                bool momentaryRawHigh,
                std::uint32_t nowMs) noexcept;
...
private:
    ...
    OnOffMomentarySwitchConfig config_{};
    MomentaryButton maintained_{};
    MomentaryButton momentary_{};
    OnOffMomentarySwitchSnapshot snapshot_{};
};
